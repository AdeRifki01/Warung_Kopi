...
<div class="container page-container" data-aos="fade-up">
    ...
    <div class="mb-4 category-filters">
        <button class="btn btn-filter btn-sm rounded-pill active">All</button>
        <button class="btn btn-filter btn-sm rounded-pill btn-outline-dark">Coffee</button>
        <button class="btn btn-filter btn-sm rounded-pill btn-outline-dark">Non Coffee</button>
        <button class="btn btn-filter btn-sm rounded-pill btn-outline-dark">Snack</button>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <img src="{{ asset('assets/img/products/coffee1.png') }}" class="img-fluid">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <img src="{{ asset('assets/img/products/coffee2.png') }}" class="img-fluid">
                ...
                <div class="p-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <form action="/cart/add" method="POST">
                            ...
                            <button class="btn btn-dark btn-sm rounded-pill" onclick="showToast()">
                                + Add
                            </button>
                        </form>
                    </div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <img src="{{ asset('assets/img/products/mactha1.png') }}" class="img-fluid">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <img src="{{ asset('assets/img/snack/croissant.png') }}" class="img-fluid">
